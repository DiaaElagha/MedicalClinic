...
namespace MedicalClinic.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Booking.Include(b => b.Doctor).Include(b => b.Patient);
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,PatientId,ReservationDateTime,Id")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,PatientId,ReservationDateTime,Id")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
